...
% Last Modified by GUIDE v2.5 07-Jun-2022 12:15:31
...
axes(handles.axes10); imshow(handles.Result.Image); title('原图像');
...
if ~isempty(handles.Result)
    ...
    axes(handles.axes10); imshow(handles.Result.hist); title('直方图均衡化图像');
end
...
if ~isempty(handles.Result)
    ...
    axes(handles.axes10); imshow(handles.Result.Medfilt); title('中值滤波图像');
end
...
if ~isempty(handles.Result)
    axes(handles.axes1); imshow(handles.Result.Image); title('原图像');
    axes(handles.axes8); imshow(handles.Result.Bw); title('二值图像');
    axes(handles.axes10); imshow(handles.Result.Bw); title('二值图像');
end
...
if ~isempty(handles.Result)
    ...
    axes(handles.axes10); imshow(handles.Result.Enance); title('增强图像');
end
...
if ~isempty(handles.Result)
    ...
    axes(handles.axes10); imshow(handles.Result.BwFilter); title('二值图像滤波');
end
...
if ~isempty(handles.Result)
    ...
    axes(handles.axes10); imshow(handles.Result.CrackRec); title('裂缝识别');
end
...
if ~isempty(handles.Result)
    ...
    axes(handles.axes10); imshow(handles.Result.CrackJudge); title('裂缝判断');
end
...
if ~isempty(handles.Result)
    axes(handles.axes1); imshow(handles.Result.Image); title('原图像');
    axes(handles.axes3); imshow(handles.Result.CrackJudge); title('裂缝图像');
    axes(handles.axes4); imshow(handles.Result.CrackJudge); title(handles.Result.str);
    axes(handles.axes9); imshow(handles.Result.CrackJudge); title('裂缝标记图像');
    hold on;
    rectangle('Position', handles.Result.rect, 'EdgeColor', 'g', 'LineWidth', 2);
    hold off;
    axes(handles.axes10); imshow(handles.Result.CrackJudge); title('裂缝标记图像');
    hold on;
    rectangle('Position', handles.Result.rect, 'EdgeColor', 'g', 'LineWidth', 2);
    hold off;
end
...
if ~isempty(handles.Result)
    axes(handles.axes1); imshow(handles.Result.Image); title('原图像');
    axes(handles.axes3); imshow(handles.Result.CrackJudge); title('裂缝图像');
    axes(handles.axes4); plot(1:size(handles.Result.Image, 1), handles.Result.Projectr);
    title('行投影');
    axes(handles.axes9); plot(1:size(handles.Result.Image, 2), handles.Result.Projectc);
    title('列投影');
end
...
if ~isempty(handles.Result)
    ...
    axes(handles.axes10); imshow(handles.Result.CrackBridge); title('裂缝拼接');
end
